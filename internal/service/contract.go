...
type Service interface {
	...
	Login(ctx context.Context, payload *dto.PublicUserLoginPayload) (sessionKey string, usr *model.Users, err error)
	...
	InsertProduct(ctx context.Context, payload *dto.PublicProduct) (err error)
